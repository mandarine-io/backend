...
func (_m *ManagerMock) Get(ctx context.Context, key string, value any) error {
...
func (_c *ManagerMock_Get_Call) Run(run func(ctx context.Context, key string, value any)) *ManagerMock_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ManagerMock_Get_Call) RunAndReturn(run func(context.Context, string, any) error) *ManagerMock_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ManagerMock) Set(ctx context.Context, key string, value any) error {
	ret := _m.Called(ctx, key, value)
...
func (_c *ManagerMock_Set_Call) Run(run func(ctx context.Context, key string, value any)) *ManagerMock_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(any))
	})
	return _c
...
func (_c *ManagerMock_Set_Call) RunAndReturn(run func(context.Context, string, any) error) *ManagerMock_Set_Call {
	_c.Call.Return(run)
	return _c
}

// SetWithExpiration provides a mock function with given fields: ctx, key, value, expiration
func (_m *ManagerMock) SetWithExpiration(ctx context.Context, key string, value any, expiration time.Duration) error {
...
func (_c *ManagerMock_SetWithExpiration_Call) Run(run func(ctx context.Context, key string, value any, expiration time.Duration)) *ManagerMock_SetWithExpiration_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ManagerMock_SetWithExpiration_Call) RunAndReturn(run func(context.Context, string, any, time.Duration) error) *ManagerMock_SetWithExpiration_Call {
	_c.Call.Return(run)
	return _c
}
